...
- Handoff checkpoint (2026-03-07):
  - seam-only decomposition is now considered saturated for the transfer side;
  - active proof target moved to
    `PLAN_78_non_h_norm_local_witness_on_sources_theorem.md`;
...
- PLAN_74/75/76 checkpoint (2026-03-04):
  ...
  - PLAN_76 step-3 refactor routed
    `molecule_residual_anchor_witness_zero_arg_source` through the explicit
    PLAN_76 cutover-source theorem
