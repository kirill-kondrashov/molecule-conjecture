...
Dependencies: `Molecule/Conjecture.lean`, `Molecule/Problem4_3.lean`, `Molecule/FeigenbaumFixedPoint.lean`, `Molecule/HyperbolicityTheorems.lean`, `plan/ARCHIVE_superseded_2026-03-04_PLAN_45_local_fixed_point_normalization_source.md`
...
- [x] Reroute final zero-arg bounds assembly through bundled non-ground source pack:
  - `MoleculeResidualNonGroundSources`
  - `molecule_residual_non_ground_sources`
  - `molecule_residual_bounds_seed_free_of_non_ground_sources`
- [ ] Replace the body of `molecule_residual_non_ground_sources` with a seed-free constructor.
- [ ] Re-run `make build`, `make check`, and targeted `#print axioms`:
  - `Molecule.molecule_residual_non_ground_sources`
