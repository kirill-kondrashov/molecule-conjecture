...
- [x] Build a localized orbit-control witness path that does not rely on `False.elim` routes.
- [x] Resolve bounds dead-end via contract realignment, then discharge bounds in PLAN_41.
- [x] Remove the residual axiom declaration and route the zero-arg theorem entirely through theorem-level data.
